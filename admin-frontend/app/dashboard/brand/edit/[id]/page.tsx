        ...
        <div className='panel-card-body'>
          <div className="grid 2xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-5">
            ...
            <div className='lg:col-span-2 md:col-span-2 sm:col-span-1'>
              <ImageInput multiple={false} thumbnailPath={inputFields.logo_url} handleChange={(event) => handleFileInputChange(event)} value={inputFields.logo} required={false} name='logo' label='Brand Logo' />
            </div>
